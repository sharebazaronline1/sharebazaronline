  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="md:ml-64 p-4 md:p-8 transition-all">
        ...
        {/* Desktop Header - Welcome + Inactive Banner (Top Right) */}
        <header className="hidden md:flex items-center justify-between mb-8">
          ...
          {/* Right Side: Inactive Banner + Profile Dropdown */}
            ...
            {accountStatus !== "active" && (
              <div className="bg-amber-50 border border-red-300 rounded-2xl px-5 py-3 flex items-center gap-3">
                <div>
                  ...
                  <p className="text-xs text-amber-700">Complete documents to trade</p>
                </div>
                <button
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          <section className="bg-white rounded-2xl p-5 border shadow-sm xl:col-span-2 h-72 flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 flex-1">
              <SmallPreIPOItem name="Tata Capital Ltd" price="₹1,050" demand="Very High Demand" />
              <SmallPreIPOItem name="Studds Accessories Ltd" price="₹1,380" demand="High Investor Interest" />
              <SmallPreIPOItem name="OYO Hotels & Homes Pvt Ltd" price="₹62" demand="IPO Watchlist" />
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl p-6 border shadow-sm xl:col-span-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <UnlistedCard name="Tata Capital Ltd" sector="NBFC" price="₹1,040" status="Active Unlisted" />
              <UnlistedCard name="HDB Financial Services Ltd" sector="NBFC" price="₹755" status="IPO Expected" />
              <UnlistedCard name="Studds Accessories Ltd" sector="Consumer Manufacturing" price="₹1,420" status="Pre-IPO" />
            </div>
          </section>
        </div>
      </main>
