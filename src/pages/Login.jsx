...
const Login = () => {
  ...
  return (
    <div
      className="flex-1 flex items-center justify-end px-12 py-12
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="p-6 pt-8 sm:p-7">
            ...
            <button className="w-full py-2.5 border border-gray-300 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-3">
