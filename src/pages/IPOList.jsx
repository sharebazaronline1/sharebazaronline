      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="p-6">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 text-left text-xs font-medium text-gray-600 uppercase tracking-wider border-b-2 border-gray-200">
                      ...
                      >
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-4">
                            ...
                            />
                            <div>
                              <p className="font-bold text-gray-900">{ipo.name}</p>
                              <p className="text-xs text-gray-500 mt-1">{ipo.fullName || "Mainboard IPO"}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-5 text-center text-gray-700">{ipo.open || "—"}</td>
                        <td className="px-6 py-5 text-center text-gray-700">{ipo.close || "—"}</td>
                        <td className="px-6 py-5 text-center font-bold text-gray-900">₹{ipo.price}</td>
                        <td className="px-6 py-5 text-center text-gray-700">{ipo.listing || "TBA"}</td>
                        <td className="px-6 py-5 text-center font-medium text-gray-900">{ipo.lot}</td>
                        <td className="px-6 py-5 text-center">
                          <div className="flex justify-center gap-3">
                            ...
                            <button
                              onClick={() => navigate(`/ipo/${ipo.id}`)}
                              className="px-5 py-2.5 rounded-lg border border-gray-400 text-gray-700 font-semibold text-sm hover:bg-gray-50 transition"
                            >
                              View 
                            </button>
                          </div>
        ...
        <div className="hidden lg:block lg:col-span-3">
          <div className="sticky top-24">
            <div className="bg-gray-100 border-2 border-dashed border-gray-400 rounded-2xl h-96 w-full flex items-center justify-center text-gray-500 font-medium">
              <div className="text-center">
                <p className="text-lg">Advertisement</p>
                <p className="text-sm mt-2">300 × 600</p>
              </div>
            </div>
          </div>
        </div>
